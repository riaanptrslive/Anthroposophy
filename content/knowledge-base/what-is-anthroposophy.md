# What Is Anthroposophy? Three Perspectives on Self-Knowledge — cumulative working knowledge base

**Author/source voices:** Rudolf Steiner; introduction Christopher Bamford.
...
Bamford introduction; three Steiner lectures, 20–22 July 1923, GA 225; notes and further reading. Current source order must be aligned anew to the 67 capture pages.

[Prior source map and reading record](../anthroposophy-introduction-review.md). Its historic coverage and pagination statements must be read with their dates and reconciled against the current source.

**Current source check:** 67-page PDF present and internally identified. Older 191-marker and replacement Markdown files are currently unavailable. Their page numbers cannot be applied directly to this PDF. New OCR is now available for all 67 capture pages; OCR availability is not a completed reading.

**Governing question [INTERPRETATION]:** How do physical, soul and spiritual perspectives change the account of self-knowledge, freedom, memory and love?

## 2. Chapter Notes

[Prior source map and reading record](../anthroposophy-introduction-review.md) preserves prior findings, limitations and chapter/lecture divisions. The new fifteen-part chapter records must be added after sequential reading, including notes and appendices. A source map is not itself a completed chapter explanation.
...
**Voices requiring separate attribution:** Bamford introduction and notes; Steiner lectures; translators Bamford and Mado Spiegler.
...
**Argument to investigate:** How do physical, soul and spiritual perspectives change the account of self-knowledge, freedom, memory and love?
...
**Specific issue worth retaining:** Build a new PDF map and OCR; retain the existing introductory connections as selective prior teaching, not full coverage.
...
**Next concrete source work:** Build a new PDF map and OCR; retain the existing introductory connections as selective prior teaching, not full coverage.

**File request:** PDF already available. Matching Markdown would accelerate transcription but is not required.
