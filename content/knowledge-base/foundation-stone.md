# The Foundation Stone Meditation — cumulative working knowledge base

**Author/source voices:** Rudolf Steiner; introduction Michael Wilson.
...
Wilson introduction; Steiner explanatory note; George Adams, Pauline Wehrle and Richard Seddon translations; original German; further reading. Most listed sections are absent from this supplied capture.

[Prior source map and reading record](../meditation-reading-review.md). Its historic coverage and pagination statements must be read with their dates and reconciled against the current source.

**Current source check:** 8-page PDF visually verified: contents list three translations and German original, but the capture stops in Steiner's note before the meditation. Existing course uses a separately identified study translation of the printed German text.

**Governing question [INTERPRETATION]:** How do the complete meditation's movements relate, and how do translation choices affect their interpretation?

## 2. Chapter Notes

[Prior source map and reading record](../meditation-reading-review.md) preserves prior findings, limitations and chapter/lecture divisions. The new fifteen-part chapter records must be added after sequential reading, including notes and appendices. A source map is not itself a completed chapter explanation.
...
**Voices requiring separate attribution:** Steiner; Wilson; three named translators; instructor study translation in current course.
...
**Argument to investigate:** How do the complete meditation's movements relate, and how do translation choices affect their interpretation?
...
**Specific issue worth retaining:** Recover the full booklet for a genuine three-translation comparison; do not treat the existing course translation as the missing edition.
...
- [Start Now! A Book of Soul and Spiritual Exercises](start-now.md): compare the actual passages and the meaning of shared terms; preserve differences in author, date and explanatory purpose.
- [Weekly Meditations: Rudolf Steiner's Calendar of the Soul](weekly-meditations.md): compare the actual passages and the meaning of shared terms; preserve differences in author, date and explanatory purpose.
...
**Next concrete source work:** Recover the full booklet for a genuine three-translation comparison; do not treat the existing course translation as the missing edition.

**File request:** Please supply the complete booklet, including all three translations and the German text.
